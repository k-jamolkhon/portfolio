...
const getInfo = () => {
  ...
  message += `<span style="color: ${mainColor}">Shell</span>: Jamolkhon\n`;
  ...
  message += `<span style="color: ${mainColor}">Email</span>: <a href="mailto:${packageJson.author.email}" target="_blank">${packageJson.author.email}</a>\n`;
